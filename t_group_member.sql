CREATE TABLE `t_group_messages_0` (
	...
	`display_mode` TINYINT(4) NOT NULL DEFAULT '1' COMMENT '消息展现模式，1：正常展现，2：敏感词屏蔽， 3：撤回，4：屏蔽',
	PRIMARY KEY (`record_id`),
	UNIQUE INDEX `idx_group_message_sender` (`group_id`, `message_id`, `sender_id`)
)
COLLATE='utf8_general_ci'
ENGINE=InnoDB
AUTO_INCREMENT=123953
;
